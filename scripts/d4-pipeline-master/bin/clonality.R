...
# Display Two-metric evaluation results:
print("Clonality Two-metric evaluation results:") 
print(paste0("LLR2: ",cln$clonTab$llr2)) 
print(paste0("Corr: ",1 - cln$clonTab$cor)) 
...
## inv triangle is clonal, X is non-clonal
points(GoldStandard_Data$llr2,GoldStandard_Data$cor,  pch=ifelse(as.integer(as.factor(GoldStandard_Data$clonality)) == 1,6,7), cex=0.4, col =rgb(0, 0, 0, 0.3))
